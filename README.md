...
1. Explain the difference between `Relational Databases` and `SQL`.
  ...
  SQL is used to talk to and is how we access the Relational Databases. 

2. Why do tables need a `primary key`?

  A primary key is a way to uniquely identify each entry in the database. You won't be able to call a specific data point without it.
...
4. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  "Intermediary" table that contains
